...
- Member photos under `public/images/people/` and any other photos depicting identifiable individuals.
- Personal or sensitive information contained in `src/content/people.yml` (e.g., names, emails, bios, links). Treat this file as data provided for the site only; do not reuse or republish.
